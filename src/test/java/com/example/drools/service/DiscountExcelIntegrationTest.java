...
import com.example.drools.model.Customer.CustomerType;
...
public class DiscountExcelIntegrationTest {
    ...
    @Before
    public void setup() {
        Resource resource = ResourceFactory.newClassPathResource("com/example/drools/rules/Discount.xls", getClass());
