...
public class DroolsBeanFactory {
    ...
    private static final String RULES_PATH = "com/example/drools/rules/";
    ...
    public KieSession getKieSession() {
        ...
        kieFileSystem.write(ResourceFactory.newClassPathResource("com/example/drools/rules/BackwardChaining.drl"));
